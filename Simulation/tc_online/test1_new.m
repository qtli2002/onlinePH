function [T_1,VAR_1,T_2,VAR_2,T_3,VAR_3]=test1_new(G_1,G_2,G_3,Beta_best,omega,U,T_temp1_sum,T_temp2_sum,T_temp3,df_times_sum,N,sigma)
%Beta_G_1
Beta_G_1 = Beta_best;
Beta_G_1(G_1) = 0;
%Beta_G_2
...
T_3 = Beta_G_3'*Beta_G_3-2*Beta_G_3'*omega*U+(2/N)*T_temp1_sum+2*Beta_G_3'*T_temp3;
VAR_3 = 4*Beta_G_3'*omega*(df_times_sum/N)*omega*Beta_G_3+4*(sigma^2)*T_temp2_sum/N;
end