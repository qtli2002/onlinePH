function [T_4,VAR_4,T_5,VAR_5,T_6,VAR_6]=test2_new(G_1,G_2,G_3,Beta_best,omega,U,T_temp1_sum,T_temp2_sum,T_temp3,df_times_sum,N,sigma,Cov0,Cov_est,T_temp4_sum,T_temp5_sum)
%Beta_G_1
Beta_G_1 = Beta_best;
Beta_G_1(G_1) = 0;
...
Beta_G_3 = Beta_best;
Beta_G_3(G_3) = 0;
Cov_G_3 = Cov0; Cov_G_3(:,G_3) = 0; Cov_G_3(G_3,:) = 0;
Sigma_tilde_3 = Cov_est; Sigma_tilde_3(:,G_3) = 0; Sigma_tilde_3(G_3,:) = 0;
...
T_6 = Beta_G_3'*Cov_G_3*Beta_G_3-2*Beta_G_3'*Sigma_tilde_3*omega*U...
    +(2/N)*T_temp1_sum+2*Beta_G_3'*Sigma_tilde_3*T_temp3;
VAR_6 = 4*Beta_G_3'*Sigma_tilde_3*omega*(df_times_sum/N)*omega*(Beta_G_3'*Sigma_tilde_3)'...
    +4*(sigma^2)*T_temp2_sum/N...
    +T_temp4_sum(1,3)/N-4*Beta_G_3'*Sigma_tilde_3*omega*T_temp5_sum(:,3)/N;